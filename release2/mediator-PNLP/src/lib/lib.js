...
exports._buildRequisitionResourceWithRegionRefEntryFromESIGL=function buildRequisitionResourceWithRegionRefEntryFromESIGL(oRequisition,extensionBaseUrlRequisitionDetails,urlSIGLDomain,regionId){
	let extensionElements=[];
	var identifierCodingSystem=urlSIGLDomain+"/identifier-type";
	var oIdentifier=[];
	let resourceId=oRequisition.requisitionId+"-"+oRequisition.productCode+"-"+oRequisition.programCode;
...
exports.buildRequisitionResourceWithRegionRefEntryFromESIGL=function buildRequisitionResourceWithRegionRefEntryFromESIGL(oRequisition,
	extensionBaseUrlRequisitionDetails,codeSystemIdentifiersType,codeSystemEntitiesType,urlSIGLDomain,regionId){
	let extensionElements=[];
	//var identifierCodingSystem=urlSIGLDomain+"/identifier-type";
	...
	let createdDate=tempDate1.split("T")[0];
	//var createdDate=tempDate1.format('YYYY-MM-DD');
	let requisitionCode={coding:[{system:codeSystemEntitiesType,code:"requisition",display:"requisition"}],text:"requisition"};
	oIdentifier.push({
		use:"official",
		type:{coding:[{system:identifierCodingSystem,code:"requisitionId",display:"requisitionId"}],text:"requisitionId"},
		value:oRequisition.requisitionId
